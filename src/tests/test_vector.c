...
static char * test_length() {
    ...
    Vector3D vector = vector3d_create(3.0, 4.0, 12.0);
...
static char * test_arithmatic() {
    ...
    Vector3D vector1 = vector3d_create(1.0, 4.0, 2.0);
    Vector3D vector2 = vector3d_create(3.0, 1.0, 2.0);
    Vector3D vector3 = vector3d_create(3.0, 4.0, -1.0);
    Vector3D added   = vector3d_add(vector2, vector3);
    Vector3D scaled  = vector3d_scale(2, vector1);
    Vector3D out     = vector3d_subtract(added, scaled);
    ...
    vector3d_cleanup(vector1);
    vector3d_cleanup(vector2);
    vector3d_cleanup(vector3);
    return 0;
}
